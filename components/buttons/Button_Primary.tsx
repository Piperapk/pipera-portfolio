        ...
        <Fragment>
            {openInNewWindow ? 
                <a id={id} href={href} target='_blank' rel='noreferrer'>
                    ...
                    transition-colors duration-150 ease-out pf:hh:hover:text-rose-400 pf:hh:hover:bg-white pf:hh:hover:outline-1 pf:hh:hover:outline pf:hh:hover:outline-offset-[-1px] pf:hh:hover:outline-rose-400
