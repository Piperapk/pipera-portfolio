  ...
  return(
    <div>
      ...
      <div className='flex flex-wrap sm:flex-nowrap grid-cols-2 grid-rows-1 max-w-4xl m-auto'>
        ...
        mx-4 sm:ml-0 sm:mr-8 mb-9 sm:mb-5
        text-center sm:text-right sm:text-2xl text-lg font-light border-y-[1px] sm:border-0 border-gray-300'>
        ...
        grid-rows-3 sm:space-y-14 space-y-2'>
          ...
          <div>
            <div className='flex pt-2 space-x-1.5 justify-center sm:justify-start'>
                ...
                <a href='https://www.instagram.com/piperapk/' target='_blank' rel='noreferrer'>
                  <Image src={'/media/icon_instagram.svg'} alt='GitHub profile' width={30} height={30}/>
                </a>
            </div>
            <div className='text-lg sm:text-base md:text-lg text-gray-500 leading-tight'>
              <a href='mailto:i.krushkov@outlook.com'>i.krushkov@outlook.com</a>
            </div>
          </div>
          <div className='flex justify-center sm:justify-start sm:pt-10 pt-5 items-end space-x-4'>
