    ...
    <div id={id} className="mt-20">
      <div className={`${containerWidth} m-auto flex items-end`}>
        <div onClick={iconClick}>
          {isIconClick ? (
            <div className="relative pl-5 cursor-default sm:cursor-pointer">
              <div className="absolute scale-[0.33] top-[-16px] -right-[12px] animate-fade-in">
                <Image
                  src={"/media/icon_resume_tap.svg"}
                  alt="resume icon"
                  width={40}
                  height={26}
                  priority
            ...
            <div className="relative pl-5 cursor-default sm:cursor-pointer">
              <div className="absolute scale-[0.33] top-[-16px] -right-[12px] animate-fade-out">
                <Image
                  src={"/media/icon_resume_tap.svg"}
                  alt="resume icon"
                  width={40}
      ...
      <div className="bg-gray-100 dark:bg-slate-700 pt-10 pb-20 sm:pt-14">
        <div
          className={`${containerWidth} m-auto
        ...
        <div
          className={`${containerWidth} m-auto gap-x-8 gap-y-5 px-10 lg:px-0 py-10
                flex flex-wrap`}
        >
          <div className="flex-auto w-80">
            <Text_Card
              ...
              sections={[
                {
                  sectionId: 0,
                  sectionTitle: "Software development skills:",
                  sectionList: [
                ...
                {
                  sectionId: 1,
                  sectionTitle: "Software development practices:",
                  sectionList: [
          ...
          <div className="flex-auto w-80">
            <Text_Card
              ...
              sections={[
                {
                  sectionId: 0,
                  sectionTitle: "Responsibility and Leadership:",
                  sectionList: [
                ...
                {
                  sectionId: 1,
                  sectionTitle: "Product and commercial skills:",
                  sectionList: [
        ...
        <div className={`${containerWidth} m-auto px-5 sm:px-0 mt-8`}>
          ...
          <div className="border-t border-slate-300" />
          <h4 className="text-lg font-semibold text-center my-12">
