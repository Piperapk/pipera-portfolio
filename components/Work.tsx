...
const Work = forwardRef(({containerWidth, id}: Props, ref) => (
        ...
        <Fragment>
            ...
            <div className="p-10 sm:pt-10 space-y-10">
                ...
                />
                <Work_Card containerWidth={containerWidth}
                title={"Next.js SSG Based Portfolio"}
                textBodyCase={"Using the latest web tech and a Jamstack paradigm, a refresh of my Wordpress based portfolio was needed. "}
                textBodyOutcome={"New portfolio. Fluid, fast and build from scratch on the latest available web frameworks. Designed with inspiration from Bauhaus and the Modernism movements. Deployed on the edge."}
                tagButtons={[{text: "Next.js"}, {text: "React"}, {text: "Tailwind"}, {text: "GitHub"},{text: "Adobe XD"}]}
