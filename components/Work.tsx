    ...
    return(
        <Fragment>
            ...
            <div className="p-10 sm:pt-16 space-y-10">
                <Work_Card containerWidth={props.containerWidth}
            ...
            <div className={`${props.containerWidth} m-auto px-5 sm:px-0 mt-8`}>
            ...
            <div className="p-10 sm:pt-10 space-y-10">
                <Work_Card_Small containerWidth={props.containerWidth}
