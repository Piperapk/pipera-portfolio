  ...
  return (
    <div className="mt-20">
      ...
      <div className="bg-gray-100 px-10 pt-10 pb-20 dark:bg-slate-700">
        ...
        >
          <p
            className="sm:basis-2/3 self-center sm:pl-5 py-10
          ...
          <div className="hidden sm:block sm:basis-1/3 self-end sm:pl-12 sm:pt-5 containerWidth:pt-0">
            <div className="w-[230px] h-[230px] bg-white flex justify-center items-center shadow-md-top rounded-t-md">
              <Image
                src="/media/profile_picture_500x.jpg"
                alt="profile picture"
                height="200"
                width="200"
          ...
          <div
            className="sm:hidden self-center sm:pl-12 
        ...
        <div className={`${containerWidth} m-auto sm:pl-5 sm:pt-10 space-y-5`}>
          <div className="flex flex-wrap items-center gap-x-3 gap-y-1">
            <span className="text-lg text-slate-800 dark:text-slate-200 leading-normal tracking-tight whitespace-nowrap">
              {"Tech I've recently used:"}
            </span>
            <Button_List
              text="JavaScript, TypeScript, C++"
              bgColor="bg-secondary"
            />
            <Button_List text="React, Vue, Next.js" bgColor="bg-secondary" />
            <Button_List
              text="PostgreSQL, Firebase, Express"
              bgColor="bg-secondary"
            />
          </div>
          <div className="flex flex-wrap items-center gap-x-3 gap-y-1">
          ...
          <div className="flex flex-wrap items-center gap-x-3 gap-y-1">
            ...
            <Button_List
              text="Photoshop, Illustrator, Adobe XD"
              bgColor="bg-secondary"
            />
          </div>
        </div>
