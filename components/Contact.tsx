      ...
      <div id={id} className="bg-gray-100 dark:bg-slate-700">
        ...
        >
          <div onClick={iconClick} className="flex translate-y-[1px]">
            <div className="pl-5 cursor-default sm:cursor-pointer">
              <Image
                src={"/media/icon_contact_pencils.svg"}
                alt="contacts icon"
                width={45}
                height={45}
                priority
            ...
            <div
              className={`-ml-[11px] mt-[28px] cursor-default sm:cursor-pointer ${
                isIconClick ? "animate-slide" : ""
              }`}
            >
              <Image
                src={"/media/icon_contact_letter.svg"}
                alt="contacts icon"
                width={40}
                height={26}
                priority
      ...
      <div className={`${containerWidth} m-auto p-16 text-center space-y-6`}>
        <p className="text-base">
          ...
          <Tooltip_Responsinve
            ...
            adjustVPositionMarginTopMobile="mt-8"
          />
          ?
        </p>
        <div>
          <Button_Primary
            href="mailto:i.krushkov@outlook.com"
            text="Say hello!"
          />
        </div>
        ...
        <p className="text-sm pt-5">
          Lovingly designed and built with Next.js and Tailwind <br /> by{" "}
          <Tooltip_Responsinve
            text="Ivan Krushkov"
